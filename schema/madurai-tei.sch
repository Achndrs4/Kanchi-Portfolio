...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   ...
   <!-- This file generated [build-timestamp-elided] by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, declared: -->
   <!-- ********************* -->
   ...
   <!-- ******************************************************** -->
   <!-- constraints in en, und, mul, zxx, of which there are 123 -->
   <!-- ******************************************************** -->
   ...
   <pattern id="schematron-constraint-citestructure-outer-match-25">
   ...
   <pattern id="schematron-constraint-citestructure-inner-match-26">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-div-in-l-27">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-div-in-ab-or-p-28">
   ...
   <pattern id="schematron-constraint-only1lem-29">
      <rule context="tei:rdgGrp">
         <assert test="count(tei:lem) lt 2">Only one &lt;lem&gt; element may appear within a &lt;rdgGrp&gt;.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-variantEncodingLocation-30">
      <rule context="tei:variantEncoding">
         <report test="@location eq 'external' and @method eq 'parallel-segmentation'"> The @location value "external" is inconsistent with the parallel-segmentation method of apparatus markup.</report>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-one_ms_singleton_max-31">
   ...
   <pattern id="schematron-constraint-catchword_in_msDesc-32">
   ...
   <pattern id="schematron-constraint-duplicateDim-33">
   ...
   <pattern id="schematron-constraint-secFol_in_msDesc-34">
      <rule context="tei:secFol">
         <assert test="ancestor::tei:msDesc or ancestor::tei:egXML">The &lt;<name/>&gt; element should not be used outside of &lt;msDesc&gt;.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-signatures_in_msDesc-35">
      <rule context="tei:signatures">
         <assert test="ancestor::tei:msDesc or ancestor::tei:egXML">The &lt;<name/>&gt; element should not be used outside of &lt;msDesc&gt;.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-msId_minimal-36">
   ...
   <pattern id="schematron-constraint-no_facsimile_text_nodes-37">
   ...
   <pattern id="schematron-constraint-pathmustnotbeclosed-38">
   ...
   <pattern id="schematron-constraint-addSpan-requires-spanTo-39">
      <rule context="tei:addSpan">
         <assert test="@spanTo">The @spanTo attribute of &lt;<name/>&gt; is required.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-damageSpan-requires-spanTo-41">
      <rule context="tei:damageSpan">
         <assert test="@spanTo">The @spanTo attribute of &lt;<name/>&gt; is required.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-delSpan-requires-spanTo-43">
      <rule context="tei:delSpan">
         <assert test="@spanTo">The @spanTo attribute of &lt;<name/>&gt; is required.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-substContents1-45">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-ab-in-l-50">
   ...
   <pattern id="schematron-constraint-joinTargets3-51">
      <rule context="tei:join">
         <assert test="contains( normalize-space( @target ),' ')"> You must supply at least two values for @target on &lt;<name/>&gt;.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-MINandMAXoccurs-52">
   ...
   <pattern id="schematron-constraint-MINandMAXoccurs-53">
   ...
   <pattern id="schematron-constraint-spec-in-module-54">
      <rule context="( tei:elementSpec[@module] | tei:classSpec[@module] | tei:macroSpec[@module] )[                            ( ancestor::tei:schemaSpec | ancestor::tei:TEI | ancestor::tei:teiCorpus )                            and                            ( //tei:moduleSpec | //tei:moduleRef )                            ]">
         <assert test="( //tei:moduleSpec/@ident | //tei:moduleRef/@key ) = @module"> Specification <value-of select="@ident"/>: the value of the module attribute ("<value-of select="@module"/>") should correspond to an existing module, via a moduleSpec or moduleRef.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-deprecation-two-month-warning-55">
   ...
   <pattern id="schematron-constraint-deprecation-should-be-explained-56">
   ...
   <pattern id="schematron-constraint-only_sensible_attrs-34">
   ...
   <pattern id="schematron-constraint-modref-59">
   ...
   <pattern id="schematron-constraint-not-same-prefix-60">
      <rule context="tei:moduleRef">
   ...
   <pattern id="schematron-constraint-not-except-and-include-61">
      <rule context="tei:moduleRef">
         <report test="@except and @include">It is an error to supply both the @include and @except attributes.</report>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-child-constraint-based-on-mode-62">
   ...
   <pattern id="schematron-constraint-child-constraint-based-on-mode-63">
   ...
   <pattern id="schematron-constraint-child-valList-deprecated-64">
      <rule context="tei:elementSpec/tei:valList">
         <report test="true()"> Use of &lt;valList&gt; as a direct child of &lt;elementSpec&gt; is deprecated and will be invalid after 2027-08-31. To express a controlled vocabulary as the content model of an element, place the &lt;valList&gt; inside a &lt;content&gt; element.</report>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-no_elements_in_data_content-65">
   ...
   <pattern id="schematron-constraint-deprecate-identless-remarks-66">
      <rule context="tei:remarks">
         <assert test="@ident" role="warning"> The @ident attribute will be required on &lt;remarks&gt; after 2027-06-01.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-TagDocsNestinglistRef-67">
   ...
   <pattern id="schematron-constraint-TagDocslistRefChildren-68">
   ...
   <pattern id="schematron-constraint-no_dup_default_models-69">
   ...
   <pattern id="schematron-constraint-no_dup_models-70">
   ...
   <pattern id="schematron-constraint-no_outputs_nor_predicates_4_my_kids-71">
   ...
   <pattern id="schematron-constraint-sequencechilden-72">
      <rule context="tei:sequence">
         <assert test="count(*) gt 1">The &lt;sequence&gt; element must have at least two child elements.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-alternatechilden-73">
      <rule context="tei:alternate">
         <assert test="count(*) gt 1">The alternate element must have at least two child elements.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-interleavechilden-74">
      <rule context="tei:interleave">
         <assert test="count(*) gt 1">The &lt;interleave&gt; element must have at least two child elements.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-one-constraintDecl-per-scheme-75">
   ...
   <pattern id="schematron-constraint-empty-based-on-mode-77">
   ...
   <pattern id="schematron-constraint-empty-based-on-mode-78">
   ...
   <pattern id="schematron-constraint-empty-based-on-mode-79">
   ...
   <pattern id="schematron-constraint-sch_no_more-80">
   ...
   <pattern id="schematron-constraint-isosch-81">
   ...
   <pattern id="schematron-constraint-context-required-82">
   ...
   <pattern id="schematron-constraint-unique-constraintSpec-ident-83">
   ...
   <pattern id="schematron-constraint-usage_based_on_mode-84">
      <rule context="tei:constraintSpec[ @mode = ('add','replace')  or  not( @mode ) ]">
   ...
   <pattern id="schematron-constraint-no_duplicate_attrs-87">
      <rule context="tei:attList[ not( ancestor::tei:attList ) ]">
         <let name="notanamespace" value="'☮🄯'"/>
         <let name="defs" value="descendant::tei:attDef"/>
         <let name="nsidents"
         ...
         <let name="distinct_dups" value="distinct-values( $dups )"/>
         <assert test="count( $distinct_dups[ . ne ''] ) eq 0"> Within the attribute list defined in "<value-of select="ancestor::*[@ident][1]/@ident"/>", the following attributes have been defined multiple times: <value-of select="$distinct_dups"/>.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-attDefContents-88">
      <rule context="tei:attDef">
         <assert test="ancestor::teix:egXML[ @valid eq 'feasible']                        or @mode eq 'change'                        or @mode eq 'delete'                        or tei:datatype                        or tei:valList[ @type eq 'closed']"> Attribute: the definition of the @<value-of select="@ident"/> attribute in the "<value-of select="ancestor::*[@ident][1]/@ident"/>" <value-of select="' &lt;'"/>
            <value-of select="local-name(ancestor::*[@ident][1])"/>&gt; should have a child &lt;valList&gt; with a @type of "closed" or a child &lt;datatype&gt;.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-noDefault4Required-89">
   ...
   <pattern id="schematron-constraint-defaultIsInClosedList-twoOrMore-90">
   ...
   <pattern id="schematron-constraint-defaultIsInClosedList-one-91">
   ...
   <pattern id="schematron-constraint-restrictDataFacet-92">
      <rule context="tei:dataRef[tei:dataFacet]">
         ...
         <report test="@restriction" role="nonfatal">Data facets and restrictions cannot both be expressed on the same data reference — that is, the @restriction attribute cannot be used when a &lt;dataFacet&gt; child element is present.</report>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-restrictAttResctrictionName-93">
   ...
   <pattern id="schematron-constraint-wit-pointers-resolve-35">
      <rule context="tei:rdg[@wit] | tei:lem[@wit] | tei:witDetail[@wit]">
         <let name="declared" value="//tei:listWit/tei:witness/@xml:id"/>
         <assert test="every $w in tokenize(normalize-space(@wit), '\s+')                                     satisfies substring($w, 2) = $declared"> Every witness pointer in @wit must refer to a witness declared in listWit. Unresolved: <value-of select="string-join(for $w in tokenize(normalize-space(@wit), '\s+')                             return if (substring($w, 2) = $declared) then () else $w, ' ')"/>
         </assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-app-needs-lemma-36">
      <rule context="tei:app">
         <assert test="tei:lem"> Every apparatus entry must carry an explicit lemma, so that the reading text is editorially chosen rather than defaulted.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-indic-text-must-declare-language-37">
      <rule context="tei:TEI">
         <assert test="@xml:lang"> The root element must declare xml:lang. Script-aware indexing and transliteration both depend on it.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-alignment-is-symmetric-38">
      <rule context="tei:lg[@corresp]">
         <report test="starts-with(@corresp, '#') and                                     not(id(substring(@corresp, 2)))                                     and false()"> Placeholder: cross-document alignment is verified by the corpus-level check in scripts/validate.sh, since Schematron here sees a single document only.</report>
      </rule>
   </pattern>
   <!-- ****************** -->
   <!-- deprecation tests: -->
   ...
   <pattern>
      <rule context="tei:sequence">
         <report test="@preserveOrder" role="nonfatal">WARNING: use of deprecated attribute — @preserveOrder of the sequence element will be removed from the TEI on 2027-05-06.
                </report>
      </rule>
   </pattern>
   <pattern>
      <rule context="tei:attRef">
         <report test="@name" role="nonfatal">WARNING: use of deprecated attribute — @name of the attRef element will be removed from the TEI on 2026-11-13.
                </report>
      </rule>
   </pattern>
   <!-- **************** -->
